...
let fruitsData: [Fruit] = [
    Fruit(
        ...
        image: "blueberry",
        gredientColors: [Color("ColorBlueBerryLight"), Color("ColorBlueBerryDark")],
        description: """
    ...
    Fruit(
        ...
        image: "strawberry",
        gredientColors: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
        description: """
    ...
    Fruit(
        ...
        image: "lemon",
        gredientColors: [Color("ColorLemonLight"), Color("ColorLemonDark")],
        description: """
    ...
    Fruit(
        ...
        image: "plum",
        gredientColors: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
    ...
    Fruit(
        ...
        image: "lime",
        gredientColors: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
    ...
    Fruit(
        ...
        image: "pomegranate",
        gredientColors: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pear",
        gredientColors: [Color("ColorPearLight"), Color("ColorPearDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "gooseberry",
        gredientColors: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "mango",
        gredientColors: [Color("ColorMangoLight"), Color("ColorMangoDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "watermelon",
        gredientColors: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "cherry",
        gredientColors: [Color("ColorCherryLight"), Color("ColorCherryDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "grapefruit",
        gredientColors: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
        description: """
    ...
    Fruit(
        ...
        image: "apple",
        gredientColors: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
